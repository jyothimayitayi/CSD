...
if __name__ == '__main__':
    node = create_from_string(
        '{val:"arun",next:{val:"k madhav",next:{val:"john",next:{val:"kavya",next:{val:"raheem",next:{val:"surya",next:None}}}}}}')

    # "{val:'c',next:{val:'f',next:{val:'a',next:{val:'b',next:{val:'x',next:{val:'k',next:None}}}}}}")
    # '{val:1,next:{val:"two",next:{val:3,next:{val:4,next:{val:5,next:{val:6,next:None}}}}}}')
    print(node)
